...
public class MstCountryService {
	...
	public void countryUpdate(MstCountryRequest request, Long countryId, Long accessedBy) throws Exception {
		...
		if (mstCountryEntity == null) {
			...
			if (null != request.getContinentId())
				mstCountryEntity.setContinentId(request.getContinentId());
			if (null != request.getIsExport())
				mstCountryEntity.setIsExport(request.getIsExport());
			if (null != request.getIsImport())
				mstCountryEntity.setIsImport(request.getIsImport());
			if (null != request.getName())
				mstCountryEntity.setName(request.getName());
			if (null != request.getShortcode())
				mstCountryEntity.setShortcode(request.getShortcode());
			if (null != request.getDescription())
				mstCountryEntity.setDescription(request.getDescription());
			if (null != request.getIsActive())
				mstCountryEntity.setIsActive(request.getIsActive());
			if (null != request.getExportFrom())
				mstCountryEntity.setExportFrom(request.getExportFrom());
			if (null != request.getExportUpto())
				mstCountryEntity.setExportUpto(request.getExportUpto());
			if (null != request.getExportRecords())
				mstCountryEntity.setExportRecords(request.getExportRecords());
			if (null != request.getImportFrom())
				mstCountryEntity.setImportFrom(request.getImportFrom());
			if (null != request.getImportUpto())
				mstCountryEntity.setImportUpto(request.getImportUpto());
			if (null != request.getImportRecords())
				mstCountryEntity.setImportRecords(request.getImportRecords());
			if (null != request.getImportPointWeightage())
				mstCountryEntity.setImportPointWeightage(request.getImportPointWeightage());
			if (null != request.getExportPointWeightage())
				mstCountryEntity.setExportPointWeightage(request.getExportPointWeightage());
			if (null != request.getExporterForImport())
				mstCountryEntity.setExporterForImport(request.getExporterForImport());
			if (null != request.getImporterForExport())
				mstCountryEntity.setImporterForExport(request.getImporterForExport());
