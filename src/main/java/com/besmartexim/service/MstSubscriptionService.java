...
public class MstSubscriptionService {
	...
	@Transactional
	public void subscriptionUpdate(@Valid MstSubscriptionRequest request, Long subscriptionId,
			Long accessedBy) {
		//Optional<MstSubscription> list = mstSubscriptionRepository.findById(subscriptionId);
	...
	public MstSubscriptionResponse subscriptionList(String isCustom, String isActive, Long accessedBy) {
		...
		if(null!=srclist && !srclist.isEmpty()) {
			...
			for(MstSubscription mstSubscription:srclist) {
				...
				List<SubscriptionDetails> subDlist = mstSubscriptionDetailsRepository.findBySubscriptionid(mstSubscription.getId());
				...
				List<SubscriptionCountries> countList = supportedCountryRepository.findBySubscriptionid(mstSubscription.getId());
